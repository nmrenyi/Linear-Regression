...
degree = 1 # poly degree, i.e. n in Line2
...
# data_x = [1.65, 2.65, 3.65, 5.65, 6.65, 7.65]
# data_y = [448.36, 446.4,	444.27,	444.29,	445.07,	447.17]
...
for num, batch_size in enumerate(batches):
    ...
    print(f'{labels[num]} train coef = {w[1]}, bias = {w[0]}')
    print('')
